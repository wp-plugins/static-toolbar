...
Tags:static, toolbar, share, sharing, social, network, posts, search engine
Requires at leat: 2.7
Tested up to:2.8.5
Stable tag:0.2
...
1. the toolbar in action
2. static toolbar backend : general settings
3. static toolbar backend : social network settings
4. static toolbar backend : sharing sites settings
